  ...
  <div class="counter-con" :style="{justifyContent:option.justifyContent}">
    ...
    <div class="counter-num-con" :style="numbersStyle">
      <template v-for="(item,index) in numbers">
        <counter-item v-if="item !== '.' && item !== ',' && item !== '-' && item !== '+'" class="counter-item" :effectFlag="effectFlag" :digit="Number(item)" :style="{marginRight:option.numbers.letterSpacing + 'px',color:(autoFillNum>index)?option.numbers.autoFillColor:''}"></counter-item>
